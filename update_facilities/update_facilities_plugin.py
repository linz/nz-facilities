...
class UpdateFacilitiesPlugin:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir, "i18n", "UpdateFacilities_{}.qm".format(locale)
        )
        ...
        self.actions = []
        self.menu = self.tr(u"&Update Facilities")

        # Check if plugin was started the first time in current QGIS session
        # Must be set in initGui() to survive plugin reloads
        self.first_start = None

        self.toolbar = self.iface.addToolBar(u"Update Facilities")
        self.toolbar.setObjectName(u"Update Facilities")
        self.menu_title = u"&Update Facilities"
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate("UpdateFacilities", message)
    ...
    def add_action(
        ...
        if add_to_menu:
            ...
            self.plugin_menu = self.iface.pluginMenu().addMenu(icon, self.menu)
            # add action to the update facilities plugin in plugin menu
    ...
    def initGui(self):
        ...
        icon_path = os.path.join(__location__, "media", "update_facilities_icon.svg")

        self.add_action(
            icon_path,
            text=self.tr(u"Update Facilities"),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(self.tr(u"&Update Facilities"), action)
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg = UpdateFacilitiesDialog(self)
