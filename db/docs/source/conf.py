# -*- coding: utf-8 -*-
#
# Facilities Test documentation build configuration file, created by
...
SITE_URL = "http://nz-facilities.readthedocs.io/en/latest/"
...
project = "NZ Facilities Data Dictionary"
...
html_title = "NZ Facilities Data Dictionary"

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = "NZ Facilities Data Dictionary"
...
htmlhelp_basename = "NZ_Facilities"
...
# latex_documents = [
#    (master_doc, 'Facilities.tex', u'Facilities Data Documentation',
#     u'LINZ', 'manual'),
# ]
...
texinfo_documents = [
    (
        master_doc,
        "facilities_data_dictionary",
        u"NZ Facilities Data Dictionary",
        author,
        "LINZ",
        "Documentation for the NZ Facilities Dataset",
        "Miscellaneous",
    )
]
    ...
    if column_comment_search is not None:
        ...
        if "foreign key to the" in column_comment_result_clean_lower:
            ...
            if foreign_search is not None:
                ...
                if schema_check == "facilities_lds":
